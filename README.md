...
Схема работы: статический frontend → `/api/lead.php` → письмо на `info@remontvariator.ru` и, при настройке, дубликат в Telegram.
...
Следующий этап — антиспам, rate limit и дополнительная защита обработчика.
